    ...
    <Grid id="hero" item xs={12} style={{ padding: 0 }}>
      <div className={classes.hero}>
        ...
        <Typography className={classes.heroSubTitle} variant="h6">
          Genie connects with various popular online games and enables community
          created tournaments and challenges. The rewards are generated by the
          accrued interest of users' stake.
        </Typography>
      </div>
    </Grid>
  );
