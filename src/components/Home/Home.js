      ...
      <Grid item xs={12}>
        <div className={classes.integrateGuide}>
          ...
          <div className={classes.integrationText}>
            ...
            >
              Create a pool contract that will safely store the funds, connect your pool to a game or integrate one.
            </Typography>
          </div>
        </div>
        ...
        <div className={classes.integrateGuide}>
          ...
          <div className={classes.integrationText}>
            ...
            <Typography
              ...
              className={classes.integrationSubTitle}
            >
              Deposit to the pool with the players to generate the reward. The stake is retrieved when the game is over.
            </Typography>
          </div>
        </div>
        ...
        <div className={classes.integrateGuide}>
          ...
          <div className={classes.integrationText}>
            ...
            <Typography
              ...
              className={classes.integrationSubTitle}
            >
              The winners will be rewarded with the prize, generated by the pool's locked value.
            </Typography>
          </div>
        </div>
      </Grid>
